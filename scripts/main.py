...
def download_mmdb_files(LICENSE_KEY):
    LINKS = [
    ...
    download_dir = os.path.join(os.getcwd(), './../storage/app/mmdb/')
...
def move_mmdb_files():
    search_dir = os.path.join(os.getcwd(), './../storage/app/mmdb/')
...
def main():
    ...
    download_mmdb_files(license_key)
