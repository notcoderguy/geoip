                    ...
                    <div
                        ...
                        <div>
                            <a href="{{ route('home') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="text-indigo-300 opacity-75 hi-outline inline-block w-6 h-6">
                        ...
                        <div
                            ...
                            <nav class="space-x-4 md:space-x-6">
                                ...
                                <a href="{{ route('api') }}" class="font-semibold text-gray-300 hover:text-gray-400">
                                    <span>API</span>
                                </a>
                                <a href="{{ route('docs') }}" class="font-semibold text-gray-300 hover:text-gray-400">
                                    <span>Docs</span>
                                </a>
                            </nav>
                ...
                <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
                    <div class="text-center">
                        <h2 class="text-3xl md:text-4xl font-extrabold mb-4 text-white">
                            <span class="text-indigo-300">GeoIP</span>
                        </h2>
                        <div
                            class="font-semibold inline-flex px-2 py-1 leading-4 mb-2 text-sm rounded-full text-gray-700 bg-gray-200">
                            ...
                            <div class="p-5 lg:p-6 grow w-full">
                                @if (isset($ASN))
                                    @if (isset($ASN['ip_address']))
                                        <span class="font-semibold">IP Address:</span> {{ $ASN['ip_address'] }}<br>
                                    @endif
                                    @if (isset($ASN['autonomous_system_organization']))
                                        <span class="font-semibold">ASN:</span> {{ $ASN['autonomous_system_number'] }}
                                        ({{ $ASN['autonomous_system_organization'] }})<br>
                                    @endif
                                @endif
                                @if (isset($City))
                                    @if (isset($City['city']))
                                        <span class="font-semibold">City:</span> {{ $City['city']['names']['en'] }}<br>
                                    @endif
                                    @if (isset($City['country']))
                                        <span class="font-semibold">Country:</span>
                                        {{ $City['country']['names']['en'] }}<br>
                                    @else
                                        <span class="font-semibold">Country:</span>
                                        {{ $City['registered_country']['names']['en'] }}
                                        (Registered)<br>
                                    @endif
                                    @if (isset($City['continent']))
                                        <span class="font-semibold">Continent:</span>
                                        {{ $City['continent']['names']['en'] }}<br>
                                    @endif
                                    ...
                                    @if (isset($City['location']))
                                        ...
                                        {{ $City['location']['latitude'] }}<br>
                                        <span class="font-semibold">Longitude:</span>
                                        {{ $City['location']['longitude'] }}<br>
                                    @endif
                                @endif
                            </div>
                            <!-- END Card Body -->
